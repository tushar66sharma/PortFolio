...
export const Work = () => {
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-block bg-[#251f38] text-md font-semibold text-blue-500 rounded-full px-2 py-1 mr-2 mb-2"
                  >
                    {tag}
                  </span>
                ))}
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center p-4">
    <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden relative">
      {/* Close Button */}
        ...
        <div className="lg:p-8 p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {selectedProject.tags.map((tag, index) => (
              <span
                key={index}
                className="bg-[#251f38] text-md font-semibold text-blue-500 rounded-full px-2 py-1"
              >
                {tag}
              </span>
            ))}
